...
<body>
    ...
    <div class="container text-center mb-4 no-print" style="max-width: 900px;">
        <div class="d-flex justify-content-between align-items-center bg-white p-3 rounded-4 shadow-sm border">
            <a href="{{ route('admin.dokumen.index') }}" class="btn btn-outline-secondary fw-semibold btn-sm">
                <i class="bi bi-arrow-left me-1"></i> Kembali ke Verifikasi Dokumen
            </a>
    ...
    <div class="report-wrapper">
                ...
                <tbody>
                    @forelse($pendaftaran as $idx => $p)
                        ...
                        <tr>
                            ...
                            <td>{{ $m->asal_sma ?? '-' }}</td>
                            <td>{{ $p->jurusan->jenis_jurusan ?? '-' }}</td>
                            <td class="text-center"><span class="badge bg-success">LULUS</span></td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-4 text-muted">Belum ada calon mahasiswa yang dinyatakan lulus administrasi.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="row pt-4">
            ...
            <div class="col-5 text-center small">
                ...
                <div class="fw-bold mt-2">Ketua Panitia Seleksi Administrasi PMB,</div>
                <div style="height: 70px;"></div>
                <div class="fw-bold text-decoration-underline">Drs. Bambang Sudirman, M.Pd.</div>
                <div class="text-muted" style="font-size:0.75rem;">NIP. 19780512 200501 1 002</div>
            </div>
        </div>
    </div>
